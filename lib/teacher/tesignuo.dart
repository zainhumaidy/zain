...
class teSignup extends StatefulWidget {
  const teSignup({super.key});

  @override
  State<teSignup> createState() => _teSignupState();
}

class _teSignupState extends State<teSignup> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.of(context).pushReplacementNamed('teLogin');
              },
              child: Center(
