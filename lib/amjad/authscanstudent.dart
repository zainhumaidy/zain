...
import '../studentscan/StudentLogin.dart';
import '../studentscan/StudentScan.dart';
import '../studentscan/StudentSignup.dart';

class AuthServiceStudent extends GetxController {
  static AuthServiceStudent get instance => Get.find();
  ...
  Future<User?> signInWithEmailAndPassword(
    ...
    try {
      final credential = await firebaseAuth.signInWithEmailAndPassword(
          email: email, password: password);
      isLoading = false;
      Get.offAll(() => const StudentScanQR());
